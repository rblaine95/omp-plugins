...
They all merge into one policy — this project-scoped file adds rules, it does not take
precedence by being local; conflicts resolve by specificity like every other source
